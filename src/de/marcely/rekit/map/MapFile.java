...
public class MapFile {
	...
	public @Nullable Map load(){
		...
		try{
			...
			final BufferedArrayReader stream = new BufferedArrayReader(data);
			...
			for(int i=0; i<groupItem.num; i++){
				...
				for(int l=0; l<group.numLayer; l++){
					...
					if(layer.type == LAYERTYPE_TILES){
						...
						final BufferedArrayReader reader = new BufferedArrayReader(decData[layerTile.data]);
	...
	public static class MapTile {
		...
		public MapTile(BufferedArrayReader reader){
	...
	public static class MapTileLayer {
		...
		public MapTileLayer(byte[] data){
			final BufferedArrayReader reader = new BufferedArrayReader(data);
